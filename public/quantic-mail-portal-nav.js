...
function navMarkup(){return '<a class="qn-global-brand" href="/" aria-label="Quantic Sillage accueil"><img class="qn-global-logo" src="/assets/brand-2026/quantic-sillage-mark.svg?v=20260919.7" alt=""><span class="qn-global-wordmark">Quantic Sillage</span></a><nav class="qn-global-links" aria-label="Navigation principale"><a href="/vision/"><img class="q-nav-app-icon" src="/assets/brand-2026/vision-mark.svg" alt=""><span>Vision</span></a><a class="active" href="/mail/" aria-current="page"><img class="q-nav-app-icon" src="/assets/brand-2026/mail-mark.svg" alt=""><span>Mail</span></a><a href="/pulse/"><img class="q-nav-app-icon" src="/assets/brand-2026/pulse-mark.svg?v=20260919.7" alt=""><span>Pulse</span></a><a href="/news/"><img class="q-nav-app-icon" src="/assets/brand-2026/news-mark.svg" alt=""><span>News</span></a><a href="/downloads/"><span>Produits &amp; outils</span></a><a class="centre" href="/quantic/">Quantic ID</a></nav>'}
function ensureNav(){
  ensureTheme();
