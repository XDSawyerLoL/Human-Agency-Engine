...
export function errorText(e){
  const map={
    ...
    pulse_storage_unavailable:'Le stockage ZOON est momentanément indisponible. Tes données ne sont pas remplacées par un état vide ; réessaie dans un instant.',
    'fetch failed':'Le stockage ZOON a rencontré une coupure temporaire. Réessaie dans un instant.',
    e2ee_required:'Cette conversation exige le chiffrement de bout en bout ZOON Secure.',
    secure_recipient_unavailable:'Ce contact n’a pas encore activé ZOON Secure sur un appareil.',
    secure_device_required:'ZOON Secure doit enregistrer cet appareil avant l’envoi.',
    ...
    secure_crypto_unsupported:'Ce navigateur ne prend pas en charge les primitives cryptographiques requises par ZOON Secure.',
    ...
    secure_protocol_mismatch:'Version ZOON Secure incompatible.',
    pulse_storage_unavailable:'Le stockage ZOON est momentanément indisponible. Tes données ne sont pas remplacées par un état vide ; réessaie dans un instant.',
    ...
    identity_mismatch:'Ce compte ZOON est lié à une autre identité Quantic.',
    identity_already_linked:'Cette identité Quantic est déjà liée à un compte ZOON.',
    identity_not_registered:'Aucun compte ZOON n’est encore lié à cette identité Quantic.'
  };
