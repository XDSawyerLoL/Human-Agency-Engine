...
// Ce sont des priors structurels généraux, jamais présentés comme causalité démontrée.
...
function pairContext(a,b){
  ...
  const sameRegion=ra&&rb&&ra!=='monde'&&rb!=='monde'&&ra===rb;
...
export function buildCausalWorldModel(forecasts=[]){
  ...
  // Liens entre scénarios : uniquement s’il existe un prior de domaine ET un contexte partagé suffisant.
