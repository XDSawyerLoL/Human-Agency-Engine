...
class InformationNeed(Base):
    ...
    candidate_id: Mapped[int | None] = mapped_column(ForeignKey("candidate_interventions.id", ondelete="CASCADE"), nullable=True, index=True)
    future_run_id: Mapped[int | None] = mapped_column(ForeignKey("future_runs.id", ondelete="CASCADE"), nullable=True, index=True)
    scenario_id: Mapped[int | None] = mapped_column(ForeignKey("future_scenarios.id", ondelete="CASCADE"), nullable=True, index=True)
