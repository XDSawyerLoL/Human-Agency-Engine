...
MECHANISM_CONTRACTS = (
    ...
    {
        "mechanism_key": "mass-layoff-to-local-labor-pressure-v1",
        "domains": ["economy_labor"],
        "pattern_key": "builtin-mass-layoff-local-labor-pressure-v1",
        "event_types": ["mass_layoff", "industrial_closure"],
        "outcome_signal_types": ["job_search_activity", "labor_supply_pressure", "retraining_demand"],
        "corpus_strategies": [],
        "trigger_replay": {
            "status": "missing",
            "source_family": None,
            "point_in_time": False,
            "coverage_semantics": "no_implemented_historical_layoff_trigger_replay",
        },
        "outcome_replay": {
            "status": "missing",
            "source_family": None,
            "point_in_time": False,
            "coverage_semantics": "no_complete_historical_job_search_or_local_labor_outcome_stream",
        },
    },
    {
        "mechanism_key": "sanctions-to-supply-price-pressure-v1",
        "domains": ["geopolitics_security", "regulation_policy", "economy_labor", "supply_fuel", "energy"],
        ...
        "outcome_signal_types": ["import_friction", "availability_pressure", "consumer_price_pressure"],
        "corpus_strategies": [],
        "trigger_replay": {
            "status": "missing",
            "source_family": None,
            "point_in_time": False,
            "coverage_semantics": "no_versioned_historical_policy_trigger_adapter",
        },
        "outcome_replay": {
            "status": "missing",
            "source_family": None,
            "point_in_time": False,
            "coverage_semantics": "no_sector_specific_complete_price_or_availability_outcome_stream",
        },
    },
    {
        "mechanism_key": "civil-unrest-to-local-activity-disruption-v1",
        "domains": ["social_collective_behavior", "transport_mobility"],
        "pattern_key": "builtin-civil-unrest-mobility-disruption-v1",
        "event_types": ["civil_unrest", "mass_protest", "strike_action"],
        "outcome_signal_types": ["road_congestion", "business_closure_reports", "travel_time_deterioration", "activity_disruption"],
        "corpus_strategies": [],
        "trigger_replay": {
            "status": "missing",
            "source_family": None,
            "point_in_time": False,
            "coverage_semantics": "no_implemented_historical_collective_action_trigger_replay",
        },
        "outcome_replay": {
            "status": "missing",
            "source_family": None,
            "point_in_time": False,
            "coverage_semantics": "no_complete_local_mobility_or_activity_outcome_stream",
        },
    },
    {
