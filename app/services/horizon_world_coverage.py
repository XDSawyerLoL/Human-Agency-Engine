...
DOMAIN_CONTRACTS = (
    {
        ...
        "target_maturity": "historically_calibratable",
        "event_types": ["extreme_heat", "extreme_heat_region", "extreme_cold", "extreme_cold_region", "drought"],
        "source_domains": ["weather", "forecast_models"],
    },
    {
        "domain": "natural_hazards",
        "label": "Natural hazards",
        "target_maturity": "live_multi_source",
        "event_types": ["flood", "river_flood_risk", "wildfire", "earthquake", "tropical_cyclone", "volcano"],
        "source_domains": ["disasters", "civil_protection"],
    },
    {
        ...
        "source_domains": ["transport", "rail"],
    },
    {
        "domain": "supply_fuel",
        "label": "Supply chains & fuel",
        "target_maturity": "historically_calibratable",
        "event_types": ["supply_disruption", "fuel_supply_disruption", "critical_goods_disruption"],
        "source_domains": ["fuel", "supply", "retail"],
    },
    {
        "domain": "energy",
        "label": "Energy",
        "target_maturity": "historically_calibratable",
        "event_types": ["energy_supply_disruption", "energy_market_stress", "power_grid_disruption"],
        "source_domains": ["electricity", "energy"],
    },
    {
        "domain": "media_attention",
        "label": "Media & collective attention",
        "target_maturity": "live_multi_source",
        "event_types": [],
        "source_domains": ["news_attention", "world_events"],
    },
    {
        "domain": "geopolitics_security",
        "label": "Geopolitics & security",
        "target_maturity": "historically_calibratable",
        "event_types": ["geopolitical_conflict", "economic_sanctions", "political_instability"],
        "source_domains": ["geopolitics", "security", "world_events"],
    },
    {
        "domain": "economy_labor",
        "label": "Economy & labor",
        "target_maturity": "historically_calibratable",
        "event_types": ["mass_layoff", "corporate_distress", "industrial_closure"],
        "source_domains": ["economy", "labor", "world_events"],
    },
    {
        "domain": "public_health",
        "label": "Public health",
        "target_maturity": "historically_calibratable",
        "event_types": ["public_health_outbreak"],
        "source_domains": ["public_health", "health", "world_events"],
    },
    {
        "domain": "cyber_technology",
        "label": "Cyber & technology",
        "target_maturity": "historically_calibratable",
        "event_types": ["cyber_incident", "technology_service_outage", "internet_service_outage"],
        "source_domains": ["cyber", "technology", "world_events"],
    },
    {
        "domain": "regulation_policy",
        "label": "Regulation & policy",
        "target_maturity": "historically_calibratable",
        "event_types": ["regulatory_change", "trade_policy_change"],
        "source_domains": ["regulation", "policy", "world_events"],
    },
    {
        "domain": "financial_stress",
        "label": "Financial stress",
        "target_maturity": "historically_calibratable",
        "event_types": ["financial_stress"],
        "source_domains": ["finance", "economy", "world_events"],
    },
    {
        "domain": "personal_context",
        "label": "Personal context & exposure",
        "target_maturity": "personalized",
        "event_types": [],
        "source_domains": [],
    },
)
...
DISCOVERY_EVENT_TYPES = {
    ...
    "rail_transport_disruption",
    "internet_service_outage",
    "power_grid_disruption",
    "critical_infrastructure_outage",
    "mass_layoff",
    "industrial_closure",
    "corporate_distress",
    ...
    "regulatory_change",
    "cyber_incident",
    "technology_service_outage",
    "financial_stress",
    "energy_supply_disruption",
    "energy_market_stress",
}
...
class HorizonWorldCoverageService:
    ...
    def _maturity(event_types: set[str], source_count: int, pattern_count: int) -> tuple[str, list[str]]:
        ...
        if confirmed:
            reasons.append("live factual/operational evidence exists")
    ...
    def snapshot(self) -> dict:
        ...
        for contract in DOMAIN_CONTRACTS:
            ...
            source_keys = sorted({
                source_key
                for domain in contract["source_domains"]
                for source_key in source_domains.get(domain, set())
            })
            pattern_keys = sorted({
                pattern_key
                for event_type in event_types
                for pattern_key in pattern_by_event.get(event_type, set())
            })
